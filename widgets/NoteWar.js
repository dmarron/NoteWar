...
dojo.declare('myapp.NoteWar', [dijit._Widget, dijit._Templated], {
	...
	drawTutorial: function(event) {
		...
		if (this.tutorialPage == 1) {
			...
			ctx.fillText("In the beginning, you can only play note shifters in empty slots.",30,30);
			ctx.fillText("Once all the slots are full, you can first change one of your notes",30,60);
			ctx.fillText("followed by replacing a note shifter in any slot.  The transparent",30,90);
			ctx.fillText("notes show where the notes will be shifted to when the turn ends.",30,120);
			this.drawImage(25 + 120*0,125,120,120,1,"images/gnote.jpg",ctx);
			this.drawImage(25 + 120*1,125,120,120,1,"images/enote.jpg",ctx);
			this.drawImage(25 + 120*2,125,120,120,1,"images/cnote.jpg",ctx);
			this.drawImage(25 + 120*3,125,120,120,1,"images/dnote.jpg",ctx);
			this.drawImage(25 + 120*4,125,120,120,1,"images/gnote.jpg",ctx);
			this.drawImage(25 + 120*0,125,120,120,0.1,"images/dnote.jpg",ctx);
			this.drawImage(25 + 120*1,125,120,120,0.1,"images/fnote.jpg",ctx);
			this.drawImage(25 + 120*2,125,120,120,0.1,"images/gnote.jpg",ctx);
			this.drawImage(25 + 120*3,125,120,120,0.1,"images/gnote.jpg",ctx);
			this.drawImage(25 + 120*4,125,120,120,0.1,"images/cnote.jpg",ctx);
			ctx.font = "14pt Arial";
			ctx.fillText("+2",72,264);
			ctx.fillText("+1",194,264);
			ctx.fillText("-1",318,264);
			ctx.fillText("-2",438,264);
			ctx.fillText("+1",554,264);
			ctx.font = "18pt Arial";
			ctx.fillText("You can show the transparent notes by holding down shift.",30,290);
			ctx.fillText("Can you see how the player can win this turn?",30,320);
			ctx.fillText("Remember that you can change a single note and a single shifter.",30,350);
			ctx.fillText("Press Enter to continue or Escape to return to the menu",30,400);
		} else if (this.tutorialPage == 5) {
			this.drawImage(25 + 120*0,5,120,120,1,"images/gnote.jpg",ctx);
			this.drawImage(25 + 120*1,5,120,120,1,"images/enote.jpg",ctx);
			this.drawImage(25 + 120*2,5,120,120,1,"images/cnote.jpg",ctx);
			this.drawImage(25 + 120*3,5,120,120,1,"images/dnote.jpg",ctx);
			this.drawImage(25 + 120*4,5,120,120,1,"images/gnote.jpg",ctx);
			this.drawImage(25 + 120*0,5,120,120,0.1,"images/dnote.jpg",ctx);
			this.drawImage(25 + 120*1,5,120,120,0.1,"images/fnote.jpg",ctx);
			this.drawImage(25 + 120*2,5,120,120,0.1,"images/gnote.jpg",ctx);
			this.drawImage(25 + 120*3,5,120,120,0.1,"images/gnote.jpg",ctx);
			this.drawImage(25 + 120*4,5,120,120,0.1,"images/cnote.jpg",ctx);
			ctx.font = "14pt Arial";
			ctx.fillText("+2",72,144);
			ctx.fillText("+1",194,144);
			...
			this.drawImage(25 + 120*0,205,120,120,1,"images/gnote.jpg",ctx);
			this.drawImage(25 + 120*1,205,120,120,1,"images/dnote.jpg",ctx);
			this.drawImage(25 + 120*2,205,120,120,1,"images/cnote.jpg",ctx);
			this.drawImage(25 + 120*3,205,120,120,1,"images/dnote.jpg",ctx);
			this.drawImage(25 + 120*4,205,120,120,1,"images/gnote.jpg",ctx);
			this.drawImage(25 + 120*0,205,120,120,0.1,"images/dnote.jpg",ctx);
			this.drawImage(25 + 120*1,205,120,120,0.1,"images/enote.jpg",ctx);
			this.drawImage(25 + 120*2,205,120,120,0.1,"images/fnote.jpg",ctx);
			this.drawImage(25 + 120*3,205,120,120,0.1,"images/gnote.jpg",ctx);
			this.drawImage(25 + 120*4,205,120,120,0.1,"images/cnote.jpg",ctx);
			ctx.font = "14pt Arial";
			ctx.fillText("+2",72,344);
			ctx.fillText("+1",194,344);
			ctx.fillText("-2",317,344);
			ctx.fillText("-2",438,344);
			ctx.fillText("+1",554,344);
			ctx.strokeStyle = "#00ff00";
